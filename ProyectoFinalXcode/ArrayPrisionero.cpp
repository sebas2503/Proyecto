...
{
    ofstream archivo;
    archivo.open("/Users/luisarroyo/Desktop/XcodeProyecto/ProyectoFinalXcode/ProyectoFinalXcode/RegistroPrisionero.txt",ios::trunc);
    for(int i=0;i<size1;i++)
    {
...
void ArrayPrisionero::LecturaArrPrisionero()
{
    ...
    string aux_condena;
    ifstream lectura;
    lectura.open("/Users/luisarroyo/Desktop/XcodeProyecto/ProyectoFinalXcode/ProyectoFinalXcode/RegistroPrisionero.txt",ios::in);
    if(lectura.is_open())
    {
        lectura.seekg(0);
